...
static const uint32 cluster_wait_event_infos[CLUSTER_WAIT_EVENTS_COUNT] = {
	 ...
	 * / EXTENT_CLAIM enum events stay off this roster, as before) */
	WAIT_EVENT_UNDO_REMOTE_READ,
	WAIT_EVENT_UNDO_TT_LOOKUP_REMOTE,
	WAIT_EVENT_UNDO_SEGMENT_FETCH,
	WAIT_EVENT_UNDO_RETENTION_WAIT,
	WAIT_EVENT_UNDO_BLOCK_GRANT_WAIT,
	WAIT_EVENT_UNDO_BLOCK_INVALIDATE_WAIT,
	WAIT_EVENT_UNDO_BLOCK_REMASTER_WAIT,
	...
	/* spec-1.14 D11: 4-process symmetric grep (enum/lookup/count/registry). */
	...
	/* spec-3.13 D6: cleaner segment-scan I/O (4-place symmetric). */
