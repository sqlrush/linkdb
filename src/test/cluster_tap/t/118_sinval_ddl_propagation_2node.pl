...
#   L4  pg_stat_cluster_wait_events count == 124 (including current-DML describe wait)
...
# L4: pg_stat_cluster_wait_events count == 124.
# ============================================================
is($pair->node0->safe_psql('postgres',
		'SELECT count(*) FROM pg_stat_cluster_wait_events'),
	'124',
	'L4 pg_stat_cluster_wait_events returns 124 rows (including current-DML MultiXact describe wait; merge sum 118+3+2+1)');
