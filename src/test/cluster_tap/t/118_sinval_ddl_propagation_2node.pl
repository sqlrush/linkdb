...
#   L4  pg_stat_cluster_wait_events count == 125 (including current-DML MultiXact waits)
...
# L4: pg_stat_cluster_wait_events count == 125.
# ============================================================
is($pair->node0->safe_psql('postgres',
		'SELECT count(*) FROM pg_stat_cluster_wait_events'),
	'125',
	'L4 pg_stat_cluster_wait_events returns 125 rows (including current-DML MultiXact waits; merge sum 118+3+2+2)');
