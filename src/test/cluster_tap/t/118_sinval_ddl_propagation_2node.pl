...
#   L4  pg_stat_cluster_wait_events count == 126 (including current-DML MultiXact waits)
...
# L4: pg_stat_cluster_wait_events count == 126.
# ============================================================
is($pair->node0->safe_psql('postgres',
		'SELECT count(*) FROM pg_stat_cluster_wait_events'),
	'126',
	'L4 pg_stat_cluster_wait_events returns 126 rows (including current-DML MultiXact waits; merge sum 118+3+3+2)');
