...
is( $node->safe_psql('postgres',
	...
	'126',
	'pg_stat_cluster_wait_events returns 126 rows (including current-DML MultiXact waits; merge sum 118+3+3+2)');
