...
is( $node->safe_psql('postgres',
	...
	'185',	'pg_stat_cluster_injections returns the exact 185-row registry including the R2 share-barrier seam');
...
is( $node->safe_psql(
	...
	'185 injection point names match the full registry including the R2 share-barrier seam');
