...
#	  L3  pg_cluster_state.gcs category has 119 keys (PCM-X queue observability +3) (cumulative through
...
is($pair->node0->safe_psql(
   ...
   '126',
   'L5 total cluster wait event count = 126 (including current-DML MultiXact waits)');
