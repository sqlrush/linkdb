 ...
 *	    L13 CLUSTER_WAIT_EVENTS_COUNT == 126 (current spec-3.6b D8 snapshot)
...
UT_TEST(test_cluster_wait_events_count_126)
{
	 ...
	 * spec-6.13 D8 -> 118; spec-5.22b D2-6 +3 undo-block waits;
	 * spec-7.2 D6 +2 LMS data-plane -> 123;
...
main(void)
{
	...
	UT_RUN(test_cluster_wait_events_count_126);
