...
extern uint64 cluster_cr_server_terminal_resample_commit_count(void);
extern uint64 cluster_cr_server_terminal_resample_abort_count(void);
extern uint64 cluster_cr_server_terminal_resample_unknown_count(void);
extern uint64 cluster_cr_server_other_refuse_not_authoritative_count(void);
extern uint64 cluster_cr_server_other_refuse_not_mine_count(void);
extern uint64 cluster_cr_server_other_refuse_expected_segment_invalid_count(void);
extern uint64 cluster_cr_server_other_refuse_expected_slot_invalid_count(void);
extern uint64 cluster_cr_server_other_refuse_segment_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_slot_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_confirm_resolve_kind_count(void);
extern uint64 cluster_cr_server_other_refuse_confirm_segment_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_confirm_slot_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_confirm_wrap_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_confirm_scn_mismatch_count(void);
extern uint64 cluster_cr_server_other_refuse_terminal_unknown_count(void);
extern uint64 cluster_cr_server_other_refuse_residual_count(void);
