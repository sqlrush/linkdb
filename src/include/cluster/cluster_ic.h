...
/* Resource-X final-cutover capability allocation.  R6 contributes identity
 * and drain callbacks but does not advertise this bit; the final carrier
 * owner advertises it only when the complete target decoder is installed. */
...
StaticAssertDecl((PGRAC_IC_HELLO_CAP_DEFINED_MASK & UINT32_C(0x00044000)) == 0,
				 "PGRAC HELLO reserved capability holes were allocated");
StaticAssertDecl(PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_SMART_FUSION_REPLY_V2)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_UNDO_AUTHORITY_SERVE_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_UNDO_HORIZON_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_CAPS_REPLY_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_GCS_DONE_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_XID_NATIVE_DISABLE_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_XID_AUTHORITY_FLOCK_V2)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_GCS_INVAL_BUSY_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_UNDO_HORIZON_IDLE_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_PCM_X_CONVERT_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_PCM_X_REBASE_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_PCM_X_SOURCE_FLOOR_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_SEMANTIC_ACTIVATION_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_R4_SYNC_CR_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_SEMANTIC_ACTIVATION_ACK_V1)
					 && PGRAC_IC_HELLO_CAP_IS_SINGLE_BIT(PGRAC_IC_HELLO_CAP_MULTIXACT_CURRENT_V1)
