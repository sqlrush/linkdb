...
PG_KEYWORD("rac", RAC, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("rolling", ROLLING, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("two_stage", TWO_STAGE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("updates", UPDATES, UNRESERVED_KEYWORD, BARE_LABEL)
